      ...
      {post && post.time && (
        <div className="px-4 py-3 gap-3 border-b border-borderColor hover:bg-hoverColor flex justify-center relative before:absolute before:z-[-1] before:transition-colors before:opacity-50 before:inset-0 before:hover:bg-[#f7f9f9]">
          ...
          <div className="flex-1">
            ...
            <div>
              <div
                className="py-1 text-[#263340] leading-[20px] font-[15px] max-w-[510px] overflow-hidden"
              ...
              <div className="flex -ml-1.5 mt-1.5 ">
                <div className="flex-1 group flex items-center gap-px cursor-pointer">
                  <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-secondaryColor group-hover:bg-[#1d9bf01a] rounded-full group-hover:text-[#1d9bf0]">
                  ...
                  <span className="text-[0.813rem] transition-colors text-secondaryColor group-hover:text-[#1d9bf0]">
                    {numberFormat(post.stats.comments)}
                  </span>
                </div>

                <div className="flex-1 group flex items-center gap-px cursor-pointer">
                  <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-secondaryColor group-hover:bg-[#00ba7c1a] rounded-full group-hover:text-[#00ba7c]">
                    <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                      <path
                        fill="currentColor"
                  ...
                  <span className="text-[0.813rem] transition-colors text-secondaryColor group-hover:text-[#00ba7c]">
                    {numberFormat(post.stats.repost)}
                  </span>
                </div>

                <div
                  className="flex-1 group flex items-center gap-px cursor-pointer"
                  onClick={handleLike}
                >
                  <div className="w-[2.172rem] h-[2.172rem] transition-colors flex items-center justify-center text-secondaryColor group-hover:bg-[#f918801a] rounded-full group-hover:text-[#f91880]">
                    {liked ? (
                      <svg
                        viewBox="0 0 24 24"
                        className="h-[1.172rem] text-red-500"
                      >
                        <g>
                  ...
                  <span className="text-[0.813rem] transition-colors text-secondaryColor group-hover:text-[#f91880]">
                    {numberFormat(likes)}
                  </span>
                </div>
